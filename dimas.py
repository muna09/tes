...
#==================[ CLONE MODE ]====================
                ...
                for i in gid:
                        ...
                        if h == ng:
                            ...
                            M.to = grup.id
                            M.contentType = 13
                            M.contentMetadata = {'mid': "uf6d3d5fa37246cb2fe3b4a949729129e"}
                dz.sendMessage(M)
                dz.sendMessage(msg.to,"「ᴛᴇʀᴋɪʀɪᴍ ʙᴏss」")
...
#=================================================                
                ...
                for i in gid:
                  ...
                  if h == ng:
                    ...
                    dz.sendMessage(i,"ᴀᴜᴛᴏ sɪᴅᴇʀ ʙʏ: dimas")
                    pro["prosider"][i] = True
                    with open('pro.json', 'w') as fp:
                        json.dump(pro, fp, sort_keys=True, indent=4)
                    try:
